...
\subsection{Getting a second, third, ... and seventh opinion}
...
<<carcinoma, fig.cap="Pathologists' diagnoses of absence (no) or presence (yes) of carcinoma in the uterine cervix based on 118 slides. Each slide is shown by a polyline.">>=
