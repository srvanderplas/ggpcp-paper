...
%
<<penguins, fig.cap="Generalized Parallel Coordinate Plot of the Palmer penguins data with sex of penguin mapped to color. Dark lines represent penguins for which sex could not be determined.", fig.height=4, fig.width=8>>=
 penguins <- penguins %>%
   mutate(
