...
\caption{\label{sketch:wrangling}What the user sees (left) and data wrangling step (right) before a parallel coordinate plot can be drawn.}
\end{figure}
